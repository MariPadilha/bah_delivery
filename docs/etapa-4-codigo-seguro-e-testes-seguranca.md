...
Esta etapa apresenta práticas de implementação segura definidas a partir dos riscos, ameaças e requisitos de segurança identificados nas etapas anteriores do projeto Bah Delivery.
...
1. **Consultas parametrizadas e validação de entrada**, relacionadas ao risco R13;
2. **[Prática 2 a definir]**, relacionada ao risco [XXX].
